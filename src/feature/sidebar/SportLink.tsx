...
const SportLink = ({ sport, toggleSidebarMenu, activeSportId }: any) => {
        ...
        >
            ...
            <div className='flex items-center'>
                ...
                <img
                    ...
                    className={`w-[8px] h-[8px] opacity-50  ${activeSportId.includes(`${sport.id}-${sport.name}`) ? "visible rotate-180 duration-150" : "invisible rotate-0 duration-150"} group-hover:visible`}
                ></img>
            </div>
        </NavLink>
    )
