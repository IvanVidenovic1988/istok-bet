    ...
    return (
        <>
            {Object.values(headerColumns).map(column => {
                ...
                if (!isColumnMarketExist) return <div className='md:w-[50%] lg:w-[50%] flex items-center justify-around '>-</div>

                return (
                    <div key={isColumnMarketExist.id} className='md:w-[50%] lg:w-[50%] flex items-center justify-around px-4'>
